...
ARG NEXT_PUBLIC_SWAPI_BASE_URL="https://swapi.dev/api"

ARG NEXT_PUBLIC_STAR_WARS_ASSETS_BASE_URL
ARG NEXT_PUBLIC_STAR_WARS_ASSETS_BASE_URL="https://starwars-visualguide.com/assets/img"
